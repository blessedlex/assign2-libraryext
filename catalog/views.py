...
def book_delete(request, pk):
    ...
    try:
        book.delete()
        messages.success(request, (book.title + ' ' + "by" + ' ' + author.first_name + author.last_name
                                   +" has been deleted"))
    except:
        messages.success(request, (book.title +" cannot be deleted. Copies of this book exist."))
